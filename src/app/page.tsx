...
const LinkedInIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-10 w-10 text-gray-500 group-hover:text-blue-500 transition-colors">
        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
    </svg>
);

const MailIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-10 w-10 text-gray-500 group-hover:text-red-500 transition-colors">
        <path d="M24 4H0V20H24V4ZM12 13.5L3 7.5H21L12 13.5Z" />
    </svg>
);

const GitHubIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-10 w-10 text-gray-500 group-hover:text-gray-900 transition-colors">
...
const LeetCodeIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-10 w-10 text-gray-500 group-hover:text-yellow-500 transition-colors">
...
const InstagramIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-10 w-10 text-gray-500 group-hover:text-pink-500 transition-colors">
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="mt-12 flex items-center justify-center gap-4 md:gap-6 max-w-5xl mx-auto">
            <a href="https://www.linkedin.com/in/rahul-yadav-2a4b3b199/" target='_blank' rel="noopener noreferrer" className="group p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200">
                <LinkedInIcon />
            </a>
            <a href="mailto:rahulkyadav9691@gmail.com" rel="noopener noreferrer" className="group p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200">
                <MailIcon />
            </a>
            <a href="https://github.com/itzrahulyadav/" target='_blank' rel="noopener noreferrer" className="group p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200">
                <GitHubIcon />
            </a>
            <a href="https://leetcode.com/u/itzrahulyadav/" target='_blank' rel="noopener noreferrer" className="group p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200">
                <LeetCodeIcon />
            </a>
            <a href="https://www.instagram.com/_rxhxlx_" target='_blank' rel="noopener noreferrer" className="group p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200">
                <InstagramIcon />
            </a>
        </div>
    </div>
        ...
        <section className="bg-white text-gray-900 pt-20 pb-20 px-4 sm:pt-24 sm:pb-24 md:pb-32 z-10 relative">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              ...
              <a href="#" className="group relative block bg-white border border-gray-200 p-6 rounded-xl overflow-hidden transition-all duration-300 hover:border-pink-500 hover:shadow-lg">
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out origin-left"></div>
