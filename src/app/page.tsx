...
const LinkedInIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7 sm:h-8 w-8 md:h-10 md:w-10 text-gray-500 group-hover:text-blue-500 transition-colors">
        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
    </svg>
);

const MailIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7 sm:h-8 w-8 md:h-10 md:w-10 text-gray-500 group-hover:text-red-500 transition-colors">
        <path d="M24 4H0V20H24V4ZM12 13.5L3 7.5H21L12 13.5Z" />
    </svg>
);

const GitHubIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7 sm:h-8 w-8 md:h-10 md:w-10 text-gray-500 group-hover:text-gray-900 transition-colors">
...
const LeetCodeIcon = () => (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7 sm:h-8 w-8 md:h-10 md:w-10 text-gray-500 group-hover:text-yellow-500 transition-colors">
      ...
      <div className={`${geist.className} bg-white`}>
          ...
          <div className="max-w-6xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-left">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tighter text-gray-900">
                Not your{' '}
                <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent px-2 py-1 rounded-md inline-block animate-fade">
            ...
            <div className="text-left">
              <p className="text-xl sm:text-2xl text-gray-600">
                Not a magician, just really good at Terraform.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="content" className="text-gray-900 bg-gray-50 py-20 px-4 sm:py-24 md:py-32 z-10 relative">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-tight text-gray-900">
              Infra so solid, even the <a href="https://netflix.github.io/chaosmonkey/" target='_blank' className='underline'>chaos monkey</a> gives up.
            </h2>
            <p className="mt-8 text-lg sm:text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent px-2 py-1 rounded-md">From Docker to deployment, every move is electric.</span>
        ...
        <section className="bg-gray-50 text-gray-900 py-20 px-4 sm:py-24 md:py-32 z-10 relative">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="mt-12 flex flex-row items-center justify-center gap-2 sm:gap-4 md:gap-6 max-w-5xl mx-auto overflow-x-auto">
              <a href="https://www.linkedin.com/in/rahul-yadav-2a4b3b199/" target='_blank' rel="noopener noreferrer" className="group p-2 sm:p-3 md:p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200 flex-shrink-0">
                <LinkedInIcon />
              </a>
              <a href="mailto:rahulkyadav9691@gmail.com" rel="noopener noreferrer" className="group p-2 sm:p-3 md:p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200 flex-shrink-0">
                <MailIcon />
              </a>
              <a href="https://github.com/itzrahulyadav/" target='_blank' rel="noopener noreferrer" className="group p-2 sm:p-3 md:p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200 flex-shrink-0">
                <GitHubIcon />
              </a>
              <a href="https://leetcode.com/u/itzrahulyadav/" target='_blank' rel="noopener noreferrer" className="group p-2 sm:p-3 md:p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200 flex-shrink-0">
                <LeetCodeIcon />
              </a>
              <a href="https://www.instagram.com/_rxhxlx_" target='_blank' rel="noopener noreferrer" className="group p-2 sm:p-3 md:p-4 rounded-full border border-gray-300 hover:bg-gray-100 transition-colors duration-200 flex-shrink-0">
                <InstagramIcon />
              </a>
            </div>
          </div>
        ...
        <section className="bg-white text-gray-900 py-20 px-4 sm:py-24 z-10 relative">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-tight text-gray-900">About Me</h1>
        ...
        <section className="bg-gray-50 text-gray-900 py-20 px-4 sm:py-24 z-10 relative">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tighter leading-tight text-gray-900">Technologies I Work With</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Tools and tech I love to work with</p>

            <div className="mt-16 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 md:gap-8">
              {skills.map((skill) => (
                <div key={skill.name} className="bg-white p-6 rounded-2xl border border-gray-200 flex flex-col items-center justify-center transition-all duration-300 hover:border-grey-200 hover:shadow-lg">
                  <Image
                    src={skill.image}
                    alt={`${skill.name} logo`}
                    width={40}
        ...
        <section className="bg-white text-gray-900 pt-20 pb-20 px-4 sm:pt-24 sm:pb-24 md:pb-32 z-10 relative">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-block relative mb-4">
              ...
              <span className="absolute -top-3 -right-4 bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 text-white text-xs font-semibold px-2 py-1 rounded-full transform -rotate-12">Epic</span>
            </div>
            <p className="text-lg text-gray-600">Solutions that cut through challenges with precision</p>

            <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <a href="https://github.com/itzrahulyadav/awsx" target="_blank" rel="noopener noreferrer" className="group relative block bg-white border border-gray-200 p-6 rounded-xl overflow-hidden transition-all duration-300 hover:border-pink-500 hover:shadow-lg">
              ...
              <a href="https://hack-the-net-412486075231.asia-south1.run.app" target="_blank" rel="noopener noreferrer" className="group relative block bg-white border border-gray-200 p-6 rounded-xl overflow-hidden transition-all duration-300 hover:border-pink-500 hover:shadow-lg">
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out origin-left"></div>
                <ContentStudioIcon />
              ...
              <a href="https://github.com/itzrahulyadav" className="group relative block bg-white border border-gray-200 p-6 rounded-xl overflow-hidden transition-all duration-300 hover:border-pink-500 hover:shadow-lg">
                ...
                <p className="mt-2 text-gray-600">The repo maybe private. Stay tuned!</p>
                <div className="mt-6 flex justify-between items-center">
